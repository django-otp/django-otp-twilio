...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TwilioSMSDevice.number'
        db.alter_column(u'otp_twilio_twiliosmsdevice', 'number', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):

        # Changing field 'TwilioSMSDevice.number'
        db.alter_column(u'otp_twilio_twiliosmsdevice', 'number', self.gf('django.db.models.fields.CharField')(max_length=16))
